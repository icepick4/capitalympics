...
import CardComponent from '@/components/Quiz/CardComponent.vue';
</script>

<template>
    <div class="flex justify-center items-center w-full">
        <div class="bg-white p-6 rounded-lg shadow-md w-1/2">
            <h1 class="text-3xl font-bold mb-4">Page en cours de création</h1>
    ...
    <div class="w-full h-full flex flex-col">
        <CardComponent
            ...
            description="Testez vos connaissances sur les différents sujets de la programmation."
            :difficulty="2"
