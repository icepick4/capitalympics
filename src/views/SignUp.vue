    ...
    <div class="flex justify-center items-center w-full my-20">
        <div class="flex flex-row w-3/5 h-full justify-center items-center">
            ...
            >
                ...
                <div class="flex flex-col items-center">
                    <button
                        class="bg-primary hover:bg-primaryhover w-3/4 hover:scale-105 transition-all duration-100 delay-75 text-xl rounded-md p-2 text-center"
                    >
                        Sign Up
                    </button>
                    <RouterLink
                        :to="{ name: 'SignIn' }"
                        class="text-primary text-center hover:text-primaryhover text-lg marker:traisition-all duration-75"
